...
struct stdnet::_Hidden::_Cpo
{
    ...
    template <typename _Data, ::stdexec::sender _Upstream>
    struct _Sender
    {
    ...
    template <typename _Arg0_t, typename... _Args_t>
        requires (!::stdexec::sender<::std::remove_cvref_t<_Arg0_t>>)
            &&   ::stdexec::tag_invocable<_Cpo, decltype(::stdexec::just()), _Arg0_t, _Args_t...>
    ...
    template <::stdexec::sender _Upstream, typename... _Args_t>
        requires ::stdexec::tag_invocable<_Cpo, _Upstream, _Args_t...>
